    ...
    <>
      ...
      <div className="px-8 py-16 space-y-24 text-black">
        ...
        <section className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h1 className="text-5xl font-bold mb-4">Meet Doug Cooper</h1>
        ...
        <section className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl font-bold mb-4">His Story</h2>
            <p className="text-lg leading-relaxed">
        ...
        {/* Photo Grid */}
        <section>
          <h2 className="text-3xl font-bold mb-6 text-center">Snapshots</h2>
